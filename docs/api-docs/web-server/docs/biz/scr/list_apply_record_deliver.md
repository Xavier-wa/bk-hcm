...
POST /api/v1/woa/bizs/{bk_biz_id}/task/find/apply/record/deliver
    ...
    "info":[
      {
        ...
        "message":"success",
        "deliverer":"xxx",
        "generate_task_id":"YT000001",
        "generate_task_link":"",
        "init_task_id":"5684804",
        "init_task_link":"http://scr.ied.com/#/sojob/list/5684804",
...
| ip	             | string	 | 资源IP        |
| asset_id	         | string	 | 固资号        |
| status	         | int	     | 交付记录状态码，0: 成功, 1: 执行中, 其他: 失败 |
| message	         | string	 | 交付记录状态信息    |
| deliverer	         | string	 | 交付人            |
| generate_task_id   | string    | 生产任务ID        |
| generate_task_link | string    | 生产任务详情链接   |
| init_task_id	     | string    | 初始化任务ID      |
| init_task_link	 | string    | 初始化任务详情链接 |
