...
技术方案：[负载均衡-购买支持独占集群-后端方案设计](https://iwiki.woa.com/p/4040244998)「七、接口设计 N-01」「十、权限与审计」「十二、后端任务拆解 B-08」；对应需求单：[资源视角下独占集群列表查询接口实现](https://tapd.woa.com/tapd_fe/69995598/story/detail/1069995598138281819)（1069995598138281819）。
