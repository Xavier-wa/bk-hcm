...
已批准需求文档 `docs/reqs/独占集群购买查询.md`（TAPD [1069995598138281929](https://tapd.woa.com/tapd_fe/69995598/story/detail/1069995598138281929)）与已定稿接口文档 `docs/api-docs/web-server/docs/biz/load-balancer/list_exclusive_cluster_tags.md`、`list_exclusive_cluster_idle_vips.md` 已经把两个接口的契约定清楚。已核实的关键代码事实：
