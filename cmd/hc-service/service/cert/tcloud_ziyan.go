...
func (svc *certSvc) initTCloudZiyanCertService(cap *capability.Capability) {
	h := rest.NewHandler()

	h.Add("CreateTCloudZiyanCert", http.MethodPost, "/vendors/tcloud-ziyan/certs/create", svc.CreateTCloudZiyanCert)
	h.Add("DeleteTCloudZiyanCert", http.MethodDelete, "/vendors/tcloud-ziyan/certs", svc.DeleteTCloudZiyanCert)
	h.Add("ListTCloudZiyanCert", http.MethodPost, "/vendors/tcloud-ziyan/certs/list", svc.ListTCloudZiyanCert)

	h.Load(cap.WebService)
}

// CreateTCloudZiyanCert ...
func (svc *certSvc) CreateTCloudZiyanCert(cts *rest.Contexts) (interface{}, error) {
	...
	_, err = syncClient.Cert(cts.Kit, params, &syncziyan.SyncCertOption{BkBizID: req.BkBizID})
	if err != nil {
...
// DeleteTCloudZiyanCert ...
func (svc *certSvc) DeleteTCloudZiyanCert(cts *rest.Contexts) (interface{}, error) {
...
// ListTCloudZiyanCert list tcloud ziyan cert
func (svc *certSvc) ListTCloudZiyanCert(cts *rest.Contexts) (interface{}, error) {
