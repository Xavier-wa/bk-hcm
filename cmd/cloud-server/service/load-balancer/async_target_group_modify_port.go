...
func (svc *lbSvc) batchModifyTargetPort(cts *rest.Contexts,
	...
	case enumor.TCloud:
		return svc.buildModifyTCloudTargetPort(cts.Kit, req.Data, tgID, baseInfo.AccountID, baseInfo.Vendor, bkBizID)
	default:
...
func (svc *lbSvc) buildModifyTCloudTargetPort(kt *kit.Kit, body json.RawMessage, tgID, accountID string,
	vendor enumor.Vendor, bkBizID int64) (interface{}, error) {
	...
	return svc.buildModifyTCloudTargetTasksPort(kt, req, ruleRelList.Details[0].LbID, tgID, accountID, bkBizID, vendor)
}
...
func (svc *lbSvc) buildModifyTCloudTargetTasksPort(kt *kit.Kit, req *cslb.TCloudBatchModifyTargetPortReq, lbID, tgID,
	accountID string, bkBizID int64, vendor enumor.Vendor) (interface{}, error) {
	...
	// 创建Flow跟Task的初始化数据
	flowID, err := svc.initFlowTargetPort(kt, req, vendor, lbID, tgID, accountID, bkBizID, taskManagementID)
	if err != nil {
		return nil, err
	}
...
func (svc *lbSvc) initFlowTargetPort(kt *kit.Kit, req *cslb.TCloudBatchModifyTargetPortReq, vendor enumor.Vendor,
	lbID, tgID, accountID string, bkBizID int64, taskManagementID string) (string, error) {
	...
	tasks, taskDetails, err := svc.buildModifyPortFlowTasks(kt, req, lbID, tgID, accountID, taskManagementID,
		bkBizID, vendor)
	if err != nil {
...
func (svc *lbSvc) buildModifyPortFlowTasks(kt *kit.Kit, req *cslb.TCloudBatchModifyTargetPortReq, lbID, tgID,
	accountID, taskManagementID string, bkBizID int64, vendor enumor.Vendor) ([]ts.CustomFlowTask,
	...
	for _, parts := range elems {
		...
		rsPortParams, err := svc.convTCloudOperateTargetReq(targets, lbID, tgID, accountID, cvt.ValToPtr(req.NewPort),
			nil)
		if err != nil {
			return nil, nil, err
		}
...
func (svc *lbSvc) createTargetGroupModifyPortTaskDetails(kt *kit.Kit, taskManagementID string, bkBizID int64,
	...
	details, err := svc.createTaskDetails(kt, taskManagementID, bkBizID,
		enumor.TaskTargetGroupModifyPort, details)
	if err != nil {
