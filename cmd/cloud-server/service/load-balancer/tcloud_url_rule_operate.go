...
func (svc *lbSvc) batchCreateUrlRule(kt *kit.Kit, vendor enumor.Vendor, lblID string, req *cslb.TCloudRuleCreate,
	...
	case enumor.TCloudZiyan:
		...
		if err != nil {
			logs.Errorf("fail to create tcloud-ziyn url rule, err: %v, rid: %s", err, kt.Rid)
			return nil, err
		}
	default:
...
func (svc *lbSvc) UpdateBizUrlRule(cts *rest.Contexts) (any, error) {
	...
	case enumor.TCloudZiyan:
		return nil, svc.client.HCService().TCloudZiyan.Clb.UpdateUrlRule(cts.Kit, lblID, ruleID, req)
	default:
...
func (svc *lbSvc) BatchDeleteBizUrlRule(cts *rest.Contexts) (any, error) {
	...
	case enumor.TCloudZiyan:
		return nil, svc.client.HCService().TCloudZiyan.Clb.BatchDeleteUrlRule(cts.Kit, lblID, req)
	default:
...
func (svc *lbSvc) BatchDeleteBizUrlRuleByDomain(cts *rest.Contexts) (any, error) {
	...
	case enumor.TCloudZiyan:
		return nil, svc.client.HCService().TCloudZiyan.Clb.BatchDeleteUrlRuleByDomain(cts.Kit, lblID, req)
	default:
		return nil, fmt.Errorf("unsupport vendor for delete rule: %s", vendor)
	}
}
