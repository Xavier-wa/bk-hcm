...
func buildUpdateSuborder(updateReq cvmapplyproto.ZiyanCvmApplySuborderUpdateReq,
	...
	suborderReq := &cvmapplytable.ZiyanCvmApplySuborder{
		...
		Isp:               updateReq.Isp,
		FailedZoneIds:     updateReq.FailedZoneIds,
		...
		ResAssign:         cvt.PtrToVal(updateReq.ResAssign),
		CPUThreadSwitch:   updateReq.CPUThreadSwitch,
		SystemDisk:        updateReq.SystemDisk,
		DataDisk:          updateReq.DataDisk,
		Zones:             updateReq.Zones,
		UpgradeCvmList:    updateReq.UpgradeCvmList,
		...
		PlanExpendGroup:   updateReq.PlanExpendGroup,
