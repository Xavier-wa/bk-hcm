...
func genZiYanPlatformManageActions() []client.ResourceAction {
	return []client.ResourceAction{{
		...
		Name:                 ActionIDNameMap[AccountBillPrepaidCreate],
		NameEn:               "Create Account Bill Prepaid",
		Type:                 Create,
		...
		Name:                 ActionIDNameMap[AccountBillPrepaidDelete],
		NameEn:               "Delete Account Bill Prepaid",
		Type:                 Delete,
		RelatedResourceTypes: mainaccountResource,
		RelatedActions:       nil,
		Version:              1,
		...
		},
		{
			...
			Name:                 ActionIDNameMap[AgentAssistantManage],
			NameEn:               "Agent Assistant Manage",
			Type:                 View,
			RelatedResourceTypes: nil,
			RelatedActions:       nil,
			Version:              1,
