...
const (
	...
	ANY_VALUE(product_marketoption) as product_marketoption,
    ANY_VALUE(product_vcpu) as product_vcpu,
    ANY_VALUE(product_memory) as product_memory,
    ANY_VALUE(product_normalization_size_factor) as product_normalization_size_factor,
