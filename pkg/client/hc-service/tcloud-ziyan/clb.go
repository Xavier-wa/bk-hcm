...
func (c *ClbClient) InquiryPrice(kt *kit.Kit, req *hcproto.TCloudZiyanLoadBalancerInquiryReq) (*typelb.TCloudLBPrice, error) {
	return common.Request[hcproto.TCloudZiyanLoadBalancerInquiryReq, typelb.TCloudLBPrice](
