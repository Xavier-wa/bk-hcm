...
// OBSBillItemGcp returns OBSBillItemGcp dao.
func (s *set) OBSBillItemGcp() obs.OBSBillItemGcp {
	return &obs.OBSBillItemGcpDao{
		Orm:   s.orm,
		IDGen: s.idGen,
	}
}
...
// ResPlanWeek resource plan week dao.
func (s *set) ResPlanWeek() resplan.ResPlanWeekInterface {
	return &resplan.ResPlanWeekDao{
		Orm:   s.orm,
		IDGen: s.idGen,
		Audit: s.audit,
	}
