...
// ZiyanCvmApplyBizRecommendColumns defines ziyan_cvm_apply_biz_recommend's columns.
var ZiyanCvmApplyBizRecommendColumns = utils.MergeColumns(nil, ZiyanCvmApplyBizRecommendColumnDescriptor)

// ZiyanCvmApplyBizRecommendColumnDescriptor is column descriptors.
var ZiyanCvmApplyBizRecommendColumnDescriptor = utils.ColumnDescriptors{
...
// ZiyanCvmApplyBizRecommend 业务维度申领机型推荐记录
type ZiyanCvmApplyBizRecommend struct {
	// ID 主键ID
...
// TableName 表名
func (z *ZiyanCvmApplyBizRecommend) TableName() table.Name {
	return table.ZiyanCvmApplyBizRecommendTable
}

// InsertValidate validate insert
func (z *ZiyanCvmApplyBizRecommend) InsertValidate() error {
	if z.BkBizID == 0 {
	...
	if err := z.RequireType.Validate(); err != nil {
		return err
	}
...
func (z *ZiyanCvmApplyBizRecommend) UpdateValidate() error {
	if len(z.Creator) != 0 {
