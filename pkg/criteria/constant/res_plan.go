...
const (
	// MaxSplitRetry is the maximum retry count for the CRP demand split race condition loop.
	MaxSplitRetry = 5

	// TransferCoreToleranceThreshold is the core-count difference threshold for greedy matching.
